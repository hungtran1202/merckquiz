...
//            wp_enqueue_style('font-css', _NP_TEMPLATE_URL . '/css/font.css', array(), _NP_THEME_VERSION);
            wp_enqueue_style('style-jquery-confirm', _NP_TEMPLATE_URL . '/assets/jquery-confirm/jquery-confirm.min.css', array(), _NP_THEME_VERSION);
        ...
        if(_NP_TEMPLATE_URL != _NP_CHILD_TEMPLATE_URL) {
            ...
            wp_enqueue_script('jquery-confirm',  _NP_TEMPLATE_URL . '/assets/jquery-confirm/jquery-confirm.min.js', array(), _NP_THEME_VERSION, true);
