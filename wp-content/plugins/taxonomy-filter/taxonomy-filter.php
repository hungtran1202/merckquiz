            ...
            jQuery(document).ready(function() {
                ...
                foreach ( $options as $taxonomy ) {
                    ...
                    if ( $taxonomy->replace == 1 ) {
                        ...
                        if ( $show_filter ) {
                            ?>
                            // Apply user hidden taxonomies filter
                            jQuery('<?php echo "#taxonomy-" . $taxonomy->slug ?>').find('<?php echo "#" . $taxonomy->slug . "checklist" ?>').find('li').each(function () {
                                ...
                                // Remove taxonomy checking user values
                                if (jQuery.inArray(normalized_taxonomy_id, <?php echo json_encode($user_hidden_taxonomies) ?>) != -1) {
                                    jQuery(this).remove();
                                }
                            });
