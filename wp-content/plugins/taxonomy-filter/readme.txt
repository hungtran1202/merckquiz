...
When you enable a taxonomy filter, a section for choosing hidden taxonomy terms is displayed in every WordPress user profile's settings page. In this page you can select a list of taxonomy terms that are removed from hierarchical term taxonomies inside admin pages.
