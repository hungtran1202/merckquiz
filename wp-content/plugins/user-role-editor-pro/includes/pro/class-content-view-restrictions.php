...
<input type="radio" id="ure_prohibit_flag" name="ure_prohibit_allow_flag" value="1"  <?php echo $selected1;?> > <label for="ure_prohibit_flag">Prohibit Access</label>&nbsp;
...
<strong><?php esc_html_e('for Roles:','user-role-editor');?></strong>&nbsp;&nbsp;<button id="edit_content_for_roles">Edit Roles List</button><br>
...
<input type="radio" id="ure_return_http_error_404" name="ure_post_access_error_action" value="1"  <?php echo $selected3;?> > <label for="ure_return_http_error_404">Return HTTP 404 error</label>&nbsp;
<input type="radio" id="ure_show_post_access_error_message" name="ure_post_access_error_action" value="2"  <?php echo $selected4;?> > <label for="ure_show_post_access_error_message">Show access error message</label><br>
